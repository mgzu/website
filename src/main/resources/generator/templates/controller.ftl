...
public class ${className}Controller extends BaseController {
    ...
    @ControllerEndpoint(value = "新增${className}", exceptionMessage = "新增${className}失败")
    ...
    @ControllerEndpoint(value = "删除${className}", exceptionMessage = "删除${className}失败")
    ...
    @ControllerEndpoint(value = "修改${className}", exceptionMessage = "修改${className}失败")
