 ...
 */
@RestController
@RequestMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "redis")
public class RedisController {
    ...
    @ControllerEndpoint(value = "执行Redis keys命令", exceptionMessage = "执行Redis keys命令失败")
    @GetMapping("keys")
    ...
    @ControllerEndpoint(value = "执行Redis get命令", exceptionMessage = "执行Redis get命令失败")
    @GetMapping("get")
    ...
    @ControllerEndpoint(value = "执行Redis set命令", exceptionMessage = "执行Redis set命令失败")
    @GetMapping("set")
    ...
    @ControllerEndpoint(value = "执行Redis del命令", exceptionMessage = "执行Redis del命令失败")
    @GetMapping("del")
    ...
    @ControllerEndpoint(value = "执行Redis exists命令", exceptionMessage = "执行Redis exists命令失败")
    @GetMapping("exists")
    ...
    @ControllerEndpoint(value = "执行Redis pttl命令", exceptionMessage = "执行Redis pttl命令失败")
    @GetMapping("pttl")
    ...
    @ControllerEndpoint(value = "执行Redis pexpire命令", exceptionMessage = "执行Redis pexpire命令失败")
    @GetMapping("pexpire")
