...
@Validated
@RestController
@RequestMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "user")
public class UserController extends BaseController {
    ...
    @ControllerEndpoint(value = "新增用户", exceptionMessage = "新增用户失败")
    @PostMapping
    ...
    @ControllerEndpoint(value = "删除用户", exceptionMessage = "删除用户失败")
    ...
    @ControllerEndpoint(value = "修改用户", exceptionMessage = "修改用户失败")
    @PostMapping("update")
