...
public class LoginController extends BaseController {
    ...
    @PostMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "login")
    ...
    @PostMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "regist")
    ...
    @GetMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "index/{username}")
    ...
    @GetMapping(FebsConstant.ADMIN_MAPPING_PREFIX + "images/captcha")
